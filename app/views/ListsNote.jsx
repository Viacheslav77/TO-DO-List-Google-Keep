...
class ListsNote extends React.Component {
    ...
    createItems() {
        ...
        // if (this.props.result.body === null) {
        //     this.body = [];
        // }
    ...
    removeButton() {
        if(this.id == 0){
            ...
            return <button id="remove-note" className="btn btn-sm btn-light m-2">delite</button>;
        }
    }
                    ...
                    <div className="container-fluid ">
                        <div className="container p-3 mt-3 border rounded bg-light shadow">
                            <form name="postForm" class='postForm'>
                                ...
                                <input type="hidden" name="id-note" value={this.id} />
                                ...
                                <div className="panel-body text-center">
                                    <button type="submit" id="save-form" className="btn btn-sm btn-light m-2">save</button>
                                    <button id="reset" className="btn btn-sm btn-light m-2">cancel</button>
                                    {this.removeButton()}
                                </div>
                            </form>
                        </div>
